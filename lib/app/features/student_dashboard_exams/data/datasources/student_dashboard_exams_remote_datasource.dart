...
abstract class StudentDashboardExamsRemoteDatasource {
  Future<RemoteDataState<List<StudentExamsResponseDto>?>> getExams({
...
class StudentDashboardExamsRemoteDatasourceImpl
    implements StudentDashboardExamsRemoteDatasource {
  @override
  Future<RemoteDataState<List<StudentExamsResponseDto>?>> getExams({
    required String studyYear,
    required int pageSize,
    ...
    List<StudentExamsResponseDto>? dataList;
    PagedList? pagedList;

    await ApiProvider.get(
      token: AuthUserUtils.token,
      url: AppUrls.studentExams(
        studyYear: studyYear,
        pageSize: pageSize,
      ...
      onSuccess: (dynamic data) {
        final networkResponse =
            NetworkResponse.fromJson<StudentExamsResponseDto>(
          data,
          StudentExamsResponseDto.fromJson,
        );
