...
import 'package:qyam_novers_mobile/app/features/teacher_profile/presentation/teacher_account/ui/teacher_account_ui_state.dart';
...
class TeacherAccountController extends GetxController {
  ...
  final state = TeacherAccountUiState.defaultObj().obs;
  ...
  void onInit() {
    ...
    on(
      event: TeacherAccountUiEvent.delayTimeOutHeader(),
    );
  }
  ...
  void on({
    required TeacherAccountUiEvent event,
  }) {
