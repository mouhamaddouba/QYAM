...
import 'package:qyam_novers_mobile/app/features/teacher_profile/presentation/teacher_profile/ui/teacher_profile_ui_state.dart';
...
class TeacherProfileController extends GetxController {
  ...
  final state = TeacherProfileUiState.defaultObj().obs;
  ...
  void on({
    required TeacherProfileUiEvent event,
  }) {
