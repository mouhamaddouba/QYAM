...
class TeacherProfilAppBarView extends GetView<TeacherProfileController> {
  const TeacherProfilAppBarView({
    Key? key,
  }) : super(
          key: key,
        );
      ...
      child: Row(
        ...
        children: [
          ...
          AppIconWidget(
            ...
            onTap: () {
              controller.on(
                event: TeacherProfileUiEvent.backtoDashboard(),
              );
            },
          ),
          ...
          AppIconWidget(
            ...
            onTap: () {
              controller.on(
                event: TeacherProfileUiEvent.toNotification(),
              );
            },
          ),
        ],
